...
execute as @e[type=interaction,scores={gravestones.Data=1},limit=1] at @s run function gravestones:find_gravestone
scoreboard players reset @e[type=interaction] gravestones.Data
tag @s remove this
