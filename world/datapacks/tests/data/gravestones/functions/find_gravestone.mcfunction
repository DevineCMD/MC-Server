...
execute as @e[type=item_display,distance=0] run execute store result score @s gravestones.IDs run data get entity @s item.tag.graveID
...
execute as @e[type=interaction,distance=0] run data remove entity @s attack
execute as @e[type=interaction,distance=0] run data remove entity @s interaction
